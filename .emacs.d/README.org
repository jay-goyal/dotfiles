...
** Font Settings
   ...
   #+begin_src emacs-lisp
	 (set-face-attribute 'default nil :font "MesloLGS Nerd Font Mono" :height 140)
	 (set-face-attribute 'fixed-pitch nil :font "MesloLGS Nerd Font Mono" :height 140)
	 (set-face-attribute 'variable-pitch nil :font "Roboto" :height 140 :weight 'regular)
	 (add-to-list 'initial-frame-alist '(font . "MesloLGS Nerd Font Mono-13.5"))
	 (add-to-list 'default-frame-alist '(font . "MesloLGS Nerd Font Mono-13.5"))
   #+end_src
