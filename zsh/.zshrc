...
alias pn='pnpm'
alias pnx='pnpm dlx'
alias install='doas emerge -aUD'
alias search='emerge --search'
alias update='doas emerge -auUD @world'
alias remove='doas emerge -aW'
alias dclean='doas emerge -ac'
alias pclean='doas emerge --ask --clean'
